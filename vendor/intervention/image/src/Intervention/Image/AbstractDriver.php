...
abstract class AbstractDriver
{
     ...
     *
     * @var \Ttc\Freebies\Intervention\Image\AbstractDecoder
     */
    public $decoder;
     ...
     *
     * @var \Ttc\Freebies\Intervention\Image\AbstractEncoder
     */
    public $encoder;
     ...
     * @return \Ttc\Freebies\Intervention\Image\Commands\AbstractCommand
     */
    ...
    private function getCommandClassName($name)
    {
        ...
        $classnameLocal = sprintf('\Ttc\Freebies\Intervention\Image\%s\Commands\%sCommand', $drivername, ucfirst($name));
        $classnameGlobal = sprintf('\Ttc\Freebies\Intervention\Image\Commands\%sCommand', ucfirst($name));
