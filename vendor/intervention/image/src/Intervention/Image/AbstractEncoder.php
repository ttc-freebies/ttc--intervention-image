...
abstract class AbstractEncoder
{
     ...
     * @return Image
     */
    public function process(\Ttc\Freebies\Intervention\Image\Image $image, $format = null, $quality = null)
    {
        $this->setImage($image);
    ...
    {
        if ($format == '' && $this->image instanceof \Ttc\Freebies\Intervention\Image\Image) {
