...
class FitCommand extends \Ttc\Freebies\Intervention\Image\Gd\Commands\ResizeCommand
{
    /**
    ...
    public function execute($image)
    {
        ...
        // calculate size
        $cropped = $image->getSize()->fit(new \Ttc\Freebies\Intervention\Image\Size($width, $height), $position);
