...
class TrimCommand extends \Ttc\Freebies\Intervention\Image\Gd\Commands\ResizeCommand
{
    /**
    ...
    public function execute($image)
    {
        ...
        if ($checkTransparency) {
            $color = new \Ttc\Freebies\Intervention\Image\Gd\Color; // color will only be used to compare alpha channel
        } else {
