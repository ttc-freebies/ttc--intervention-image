...
use Ttc\Freebies\Intervention\Image\Exception\NotWritableException;
 ...
 */
class Image extends \Ttc\Freebies\Intervention\Image\File
{
    /**
     ...
     * @param mixed  $core
     */
    public function __construct(\Ttc\Freebies\Intervention\Image\AbstractDriver $driver = null, $core = null)
    {
        $this->driver = $driver;
        $this->core = $core;
    }
    ...
    public function save($path = null, $quality = null, $format = null)
    {
        ...
        if (is_null($path)) {
            throw new \Ttc\Freebies\Intervention\Image\Exception\NotWritableException(
     ...
     * @param AbstractDriver $driver
     */
    public function setDriver(\Ttc\Freebies\Intervention\Image\AbstractDriver $driver)
    {
        $this->driver = $driver;
