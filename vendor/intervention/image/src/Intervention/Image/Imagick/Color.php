...
use Ttc\Freebies\Intervention\Image\AbstractColor;

class Color extends \Ttc\Freebies\Intervention\Image\AbstractColor
{
    /**
     ...
     *
     * @param  int $value
     * @return \Ttc\Freebies\Intervention\Image\AbstractColor
     */
     ...
     * @return boolean
     */
    public function differs(\Ttc\Freebies\Intervention\Image\AbstractColor $color, $tolerance = 0)
    {
