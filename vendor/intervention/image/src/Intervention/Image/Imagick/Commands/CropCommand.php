...
use Ttc\Freebies\Intervention\Image\Point;
use Ttc\Freebies\Intervention\Image\Size;

class CropCommand extends \Ttc\Freebies\Intervention\Image\Commands\AbstractCommand
{
    /**
    ...
    public function execute($image)
    {
        ...
        $cropped = new \Ttc\Freebies\Intervention\Image\Size($width, $height);
        $position = new \Ttc\Freebies\Intervention\Image\Point($x, $y);
