...
class TrimCommand extends \Ttc\Freebies\Intervention\Image\Commands\AbstractCommand
{
    /**
    ...
    public function execute($image)
    {
        ...
        if ($checkTransparency) {
            $base_color = new \Ttc\Freebies\Intervention\Image\Imagick\Color; // color will only be used to compare alpha channel
        } else {
