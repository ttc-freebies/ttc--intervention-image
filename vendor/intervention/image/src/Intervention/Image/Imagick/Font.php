...
use Ttc\Freebies\Intervention\Image\AbstractFont;
use Ttc\Freebies\Intervention\Image\Exception\RuntimeException;
use Ttc\Freebies\Intervention\Image\Image;

class Font extends \Ttc\Freebies\Intervention\Image\AbstractFont
{
    /**
     ...
     * @return void
     */
    public function applyToImage(\Ttc\Freebies\Intervention\Image\Image $image, $posx = 0, $posy = 0)
    {
        // build draw object
        ...
        // parse text color
        $color = new \Ttc\Freebies\Intervention\Image\Imagick\Color($this->color);
